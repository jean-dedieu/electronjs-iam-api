...
**Clone ElectonJS official git repository**

       git clone https://github.com/electron/electron-quick-start

       This will create folder "electron-quick-start"

**Install depedencies in ElectronJS**

       make sure your are in electron-quick-start folder
